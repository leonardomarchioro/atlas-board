...
function Feedback({
  ...
  return (
    <div className={`flex gap-3 rounded-md border p-4 ${styles[tone]}`} role="status">
      ...
      <div>
        <p className="font-label text-label-md">{title}</p>
    ...
    <main className="min-h-screen py-8 md:py-12">
      <div className="atlas-container space-y-12">
        <header className="flex flex-col gap-6 border-b pb-8 sm:flex-row sm:items-end sm:justify-between">
          <div className="max-w-2xl">
            ...
            <p className="mt-3 text-body-lg text-muted-foreground">
              Tokens e componentes para uma interface SaaS precisa, acessível e consistente.
            </p>
          </div>
          <ThemeToggle />
        </header>
        ...
        <Section
          ...
          description="As cores preservam o mesmo significado nos temas claro e escuro."
        >
          <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
            {swatches.map(([label, background, foreground]) => (
              <div
                key={label}
                className={`${background} ${foreground} flex min-h-24 items-end rounded-lg border p-4`}
              >
        ...
        <Section
          title="Tipografia"
          description="Inter prioriza leitura; Geist traz precisão a labels e dados técnicos."
        >
          <Card>
            <CardContent className="space-y-5">
              ...
              <div>
                <p className="text-headline-lg">Headline LG responsiva</p>
                <p className="font-label text-label-sm text-muted-foreground">
                  30 / 38 · Inter 600
                </p>
              </div>
              ...
              <p className="text-body-lg">
                Texto de apoio em body large para introduções e mensagens importantes.
              </p>
        ...
        <Section
          ...
          description="Hover, foco, active, disabled e feedback permanecem distinguíveis."
        >
          <Card>
            <CardContent className="flex flex-wrap items-center gap-3">
              ...
              <Tooltip>
                <TooltipTrigger
                  render={<Button size="icon" variant="outline" aria-label="Notificações" />}
                >
        ...
        <Section
          title="Formulários"
          description="Campos com labels associados, erro explícito e foco acessível."
        >
          <Card>
            <CardContent className="grid gap-6 md:grid-cols-2">
              <div className="space-y-2">
                <Label htmlFor="name">Campo obrigatório</Label>
                <Input id="name" placeholder="Digite um título" />
              </div>
              <div className="space-y-2">
                <Label htmlFor="disabled">Campo desabilitado</Label>
                <Input id="disabled" value="Conteúdo bloqueado" disabled readOnly />
              </div>
              <div className="space-y-2">
                ...
                />
                <p id="error-message" className="text-body-sm text-destructive">
              ...
              <div className="space-y-2 md:col-span-2">
                ...
                <Textarea id="description" placeholder="Adicione detalhes relevantes" />
              </div>
              ...
              <div className="flex items-center gap-2">
                <Switch id="automation" defaultChecked />
                <Label htmlFor="automation">Automação ativa</Label>
              </div>
            </CardContent>
          </Card>
        </Section>
        ...
        <Section
          title="Badges e feedback"
          description="Cor e texto trabalham juntos; o indicador ativo pode pulsar."
        >
          ...
          <div className="grid gap-3 lg:grid-cols-2">
            <Feedback tone="success" icon={Check} title="Sucesso">
              A operação foi concluída.
            </Feedback>
            <Feedback tone="warning" icon={TriangleAlert} title="Atenção">
              Esta ação requer confirmação.
            </Feedback>
            <Feedback tone="info" icon={Info} title="Informação">
              Há uma atualização disponível.
            </Feedback>
            <Feedback tone="destructive" icon={X} title="Erro">
        ...
        <Section
          title="Superfícies e overlays"
          description="Profundidade por camadas tonais, com sombra reservada ao modal."
        >
          <div className="grid gap-4 lg:grid-cols-2">
            <Card className="hover:bg-surface-low">
              <CardHeader>
                <CardTitle>Card de conteúdo</CardTitle>
                <CardDescription>Contorno discreto, sem sombra padrão.</CardDescription>
              </CardHeader>
              <CardContent className="flex items-center gap-3">
                ...
                <div>
                  <p className="font-label text-label-md">Equipe Atlas</p>
                  <p className="text-body-sm text-muted-foreground">12 participantes</p>
                </div>
              </CardContent>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>Skeleton acompanha a geometria final.</CardDescription>
              </CardHeader>
          ...
          <div className="flex flex-wrap gap-3">
            ...
            <Dialog>
              ...
              <DialogContent>
                <DialogHeader>
                  ...
                  <DialogDescription>
                    Este modal demonstra a superfície elevada e o foco gerenciado.
                  </DialogDescription>
                </DialogHeader>
                <DialogFooter>
            ...
            <Button
              variant="outline"
              onClick={() =>
                toast.success("Design system validado", {
                  description: "Os tokens foram aplicados corretamente.",
                })
              }
            >
              Exibir toast
        ...
        <Separator />
        <footer className="pb-4 font-label text-label-sm text-muted-foreground">
          Atlas · Sistema visual interno
        </footer>
      </div>
    </main>
  );
